...
public class CallBasedArgumentGenerator extends ArgumentGenerator {
    ...
    public void generateExpression(int i, @NotNull ExpressionValueArgument argument) {
        ...
        callGenerator.genValueAndPut(valueParameters.get(i), argumentExpression, valueParameterTypes.get(i));
    }

    @Override
    public void generateDefault(int i, @NotNull DefaultValueArgument argument) {
        Type parameterType = valueParameterTypes.get(i);
        pushDefaultValueOnStack(parameterType, codegen.v);
        callGenerator.afterParameterPut(parameterType, null, valueParameters.get(i));
    }
    ...
    public void generateVararg(int i, @NotNull VarargValueArgument argument) {
        ...
        codegen.genVarargs(argument, valueParameter.getType());
        callGenerator.afterParameterPut(valueParameterTypes.get(i), null, valueParameter);
    }
}
