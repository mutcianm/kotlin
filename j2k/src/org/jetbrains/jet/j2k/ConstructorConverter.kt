...
class ConstructorConverter(private val psiClass: PsiClass, private val converter: Converter) {
    ...
    private fun convertPrimaryConstructor(annotations: Annotations,
        ...
        val block = if (body != null) {
            ...
            val bodyConverter = converter.withExpressionVisitor {
                object : ReplacingExpressionVisitor(parameterUsageReplacementMap, it) {
        ...
        val correctedConverter = converter.withExpressionVisitor { ReplacingExpressionVisitor(parameterUsageReplacementMap, it) }
    ...
    private inner open class ReplacingExpressionVisitor(val parameterUsageReplacementMap: Map<String, String>, converter: Converter) : ExpressionVisitor(converter) {
        override fun visitReferenceExpression(expression: PsiReferenceExpression) {
